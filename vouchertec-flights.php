...
add_shortcode('TTBOOKING_ALL_SERVICES', 'get_search_services_all_flights');  
function get_search_services_all_flights(){ 
    $cor = (empty(get_option( 'cor_flights' )) ? '#000000' : get_option( 'cor_flights' ));
    $html = '';

    $html .= '<style>.nav>li>a:focus,.nav>li>a:hover{background:0 0!important}.design-process-section .text-align-center{line-height:25px;margin-bottom:12px}.design-process-content{border:1px solid #e9e9e9;position:relative;padding:16px 34% 30px 30px}.design-process-content img{position:absolute;top:0;right:0;bottom:0;z-index:0;max-height:100%}.design-process-content h3{margin-bottom:16px}.design-process-content p{line-height:26px;margin-bottom:12px}.process-model{list-style:none;padding:0;position:relative;max-width:600px;margin:20px auto 26px;border:none;z-index:0}.process-model li::after{background:'.$cor.';bottom:0;content:"";display:block;height:4px;margin:0 auto;position:absolute;right:73%;top:33px;width:14%;z-index:-1}.process-model li.visited::after{background:'.$cor.'}.process-model li:last-child::after{width:0}.process-model li{display:inline-block;width:18%;text-align:center;float:none}.nav-tabs.process-model>li.active>a,.nav-tabs.process-model>li.active>a:focus,.nav-tabs.process-model>li.active>a:hover,.process-model li a:focus,.process-model li a:hover{border:none;background:0 0}.process-model li a{padding:0;border:none;color:#606060}.process-model li.active,.process-model li.active a,.process-model li.active a:focus,.process-model li.active a:hover,.process-model li.visited,.process-model li.visited a,.process-model li.visited a:focus,.process-model li.visited a:hover{color:'.$cor.'}.process-model li a.active p,.process-model li a.visited p{font-weight:600;color:'.$cor.'}.process-model li i{display:block;height:68px;width:68px;text-align:center;margin:0 auto;background:#fff;color: '.$cor.';border:2px solid '.$cor.';line-height:65px;font-size:30px;border-radius:50%}.process-model li a.active i{background:'.$cor.';border-color:'.$cor.';color:#fff}.process-model li p{font-size:14px;margin-top:11px;margin-bottom:0px;color: '.$cor.';}.process-model.contact-us-tab li.visited a,.process-model.contact-us-tab li.visited p{color:#606060!important;font-weight:400}.process-model.contact-us-tab li::after{display:none}.process-model.contact-us-tab li.visited i{border-color:#e5e5e5}@media screen and (max-width:560px){.more-icon-preocess.process-model li span{font-size:23px;height:50px;line-height:46px;width:50px}.more-icon-preocess.process-model li::after{top:24px}}@media screen and (max-width:380px){.process-model.more-icon-preocess li{width:16%}.more-icon-preocess.process-model li span{font-size:16px;height:35px;line-height:32px;width:35px}.more-icon-preocess.process-model li p{font-size:8px}.more-icon-preocess.process-model li::after{top:18px}.process-model.more-icon-preocess{text-align:center}}
		.qtyIncFlight, .qtyDecFlight, .qtyIncMulti, .qtyDecMulti, .qtyIncHotel, .qtyDecHotel{width:28px;height:28px;line-height:22px;font-size:15px;background-color:'.(empty(get_option( 'cor_flights' )) ? '#000000' : get_option( 'cor_flights' )).'bd;-webkit-text-stroke:1px #fff;color:#333;display:inline-block;text-align:center;border-radius:50%;cursor:pointer;}
		.qtyIncFlight:hover,.qtyDecFlight:hover,.qtyIncMulti:hover,.qtyDecMulti:hover, .qtyIncHotel:hover, .qtyDecHotel:hover{background:'.(empty(get_option( 'cor_flights' )) ? '#000000' : get_option( 'cor_flights' )).'bd;}
		.qtyIncFlight:hover:before, .qtyDecFlight:hover:before, .qtyIncMulti:hover:before, .qtyDecMulti:hover:before, .qtyIncHotel:hover:before, .qtyDecHotel:hover:before{color:#fff}
		.qtyIncFlight:before, .qtyIncMulti:before, .qtyIncHotel:before, .qtyIncHotel:before{content:"\002B";font-size:19px;font-weight:900;line-height: 29px;} 
		 .qtyDecFlight:before, .qtyDecMulti:before, .qtyDecHotel:before, .qtyDecHotel:before{content:"\2212";font-size:19px;font-weight:900;line-height: 29px;} </style>';
    ...
    $html .= '<link href="//maxcdn.bootstrapcdn.com/bootstrap/4.1.1/css/bootstrap.min.css" rel="stylesheet" id="bootstrap-css">';
                            $html .= '<link rel="preconnect" href="https://fonts.googleapis.com">
                                ...
                                <link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/jquery-nice-select/1.1.0/css/nice-select.min.css" />
                                <link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css?ver=1.0">
                                <link rel="stylesheet" type="text/css" href="'.plugin_dir_url( __FILE__ ) . 'includes/assets/css/motorAllAereo.css?v='.date("YmdHis").'">';
    if ( shortcode_exists( 'TTBOOKING_MOTOR_RESERVA_FLIGHTS' ) ) {
        $html .= '<style>
            @media (min-width:992px){ 
                 .idtrecho{ 
                    background-color: '.(empty(get_option( 'cor_flights' )) ? '#000000' : get_option( 'cor_flights' )).' !important; 
                }
                 .search-sec{ 
                     background:'.(empty(get_option( 'cor_flights' )) ? '#000000' : get_option( 'cor_flights' )).' !important; 
                } 
            } 
             @media (max-width:992px){ 
                 .search-sec{ 
                    background:'.(empty(get_option( 'cor_flights' )) ? '#000000' : get_option( 'cor_flights' )).'c2 !important; 
                }  
            }   
             .qtyIncFlight,.qtyDecFlight, .qtyIncMulti,.qtyDecMulti{ 
                background-color:'.(empty(get_option( 'cor_flights' )) ? '#000000' : get_option( 'cor_flights' )).'bd; 
            }
             .qtyIncFlight:hover,.qtyDecFlight:hover,.qtyIncMulti:hover,.qtyDecMulti:hover{
                background:'.(empty(get_option( 'cor_flights' )) ? '#000000' : get_option( 'cor_flights' )).'bd;
            } 
             .daterangepicker td.in-range{
                background-color:'.(empty(get_option( 'cor_flights' )) ? '#000000' : get_option( 'cor_flights' )).'54;
                cor:'.(empty(get_option( 'cor_flights' )) ? '#000000' : get_option( 'cor_flights' )).'54;
            }
             .daterangepicker td.active, .daterangepicker td.active:hover {
                background-color:'.(empty(get_option( 'cor_flights' )) ? '#000000' : get_option( 'cor_flights' )).'; 
            }
             .daterangepicker td.available:hover, .daterangepicker th.available:hover{
                background-color:'.(empty(get_option( 'cor_flights' )) ? '#000000' : get_option( 'cor_flights' )).'99; 
            } 
             a:hover{ 
                color:'.(empty(get_option( 'cor_flights' )) ? '#000000' : get_option( 'cor_flights' )).'
            } 
             .cancelBtn{
                color:'.(empty(get_option( 'cor_flights' )) ? '#000000' : get_option( 'cor_flights' )).'bd !important
            }
             .cancelBtn:hover{
                background-color:'.(empty(get_option( 'cor_flights' )) ? '#000000' : get_option( 'cor_flights' )).'bd !important; 
            }
             .applyBtn{
                background-color:'.(empty(get_option( 'cor_flights' )) ? '#000000' : get_option( 'cor_flights' )).' !important;
                border-color:'.(empty(get_option( 'cor_flights' )) ? '#000000' : get_option( 'cor_flights' )).' !important
            }
             .applyBtn:hover{
                background-color:'.(empty(get_option( 'cor_flights' )) ? '#000000' : get_option( 'cor_flights' )).'bd !important
            } 
             ...
             .btnAddRoom:hover{
                color: '.(empty(get_option( 'cor_flights' )) ? '#000000' : get_option( 'cor_flights' )).'ee; 
            }
             .btnApplyRoom{
                background-color: '.(empty(get_option( 'cor_flights' )) ? '#000000' : get_option( 'cor_flights' )).'; 
            }
             .btnApplyRoom:hover{
                background-color: '.(empty(get_option( 'cor_flights' )) ? '#000000' : get_option( 'cor_flights' )).'d4;
            }
             .ripple{
                background-color:'.(empty(get_option( 'cor_botao_flights' )) ? '#000000' : get_option( 'cor_botao_flights' )).' !important; 
            }
             .ripple:hover{
                background-color:'.(empty(get_option( 'cor_botao_flights' )) ? '#000000' : get_option( 'cor_botao_flights' )).'80 !important
            } 
             button.typeFlight.active, button.typeFlight:hover {
                 color: '.(empty(get_option( 'cor_flights' )) ? '#000000' : get_option( 'cor_flights' )).' !important; 
            }
        ...
        $html .= '<style>
            @media (min-width:992px){ 
                 .idtrecho{ 
                    background-color: '.(empty(get_option( 'cor_ehtl' )) ? '#000000' : get_option( 'cor_ehtl' )).' !important; 
                }
                 .search-sec{ 
                     background:'.(empty(get_option( 'cor_ehtl' )) ? '#000000' : get_option( 'cor_ehtl' )).' !important; 
                } 
            } 
             @media (max-width:992px){ 
                 .search-sec{ 
                    background:'.(empty(get_option( 'cor_ehtl' )) ? '#000000' : get_option( 'cor_ehtl' )).'c2 !important; 
                }  
            }   
             .qtyIncFlight,.qtyDecFlight, .qtyIncMulti,.qtyDecMulti{ 
                background-color:'.(empty(get_option( 'cor_ehtl' )) ? '#000000' : get_option( 'cor_ehtl' )).'bd; 
            }
             .qtyIncFlight:hover,.qtyDecFlight:hover,.qtyIncMulti:hover,.qtyDecMulti:hover{
                background:'.(empty(get_option( 'cor_ehtl' )) ? '#000000' : get_option( 'cor_ehtl' )).'bd;
            } 
             .daterangepicker td.in-range{
                background-color:'.(empty(get_option( 'cor_ehtl' )) ? '#000000' : get_option( 'cor_ehtl' )).'54;
                cor:'.(empty(get_option( 'cor_ehtl' )) ? '#000000' : get_option( 'cor_ehtl' )).'54;
            }
             .daterangepicker td.active, .daterangepicker td.active:hover {
                background-color:'.(empty(get_option( 'cor_ehtl' )) ? '#000000' : get_option( 'cor_ehtl' )).'; 
            }
             .daterangepicker td.available:hover, .daterangepicker th.available:hover{
                background-color:'.(empty(get_option( 'cor_ehtl' )) ? '#000000' : get_option( 'cor_ehtl' )).'99; 
            } 
             a:hover{ 
                color:'.(empty(get_option( 'cor_ehtl' )) ? '#000000' : get_option( 'cor_ehtl' )).'
            } 
             .cancelBtn{
                color:'.(empty(get_option( 'cor_ehtl' )) ? '#000000' : get_option( 'cor_ehtl' )).'bd !important
            }
             .cancelBtn:hover{
                background-color:'.(empty(get_option( 'cor_ehtl' )) ? '#000000' : get_option( 'cor_ehtl' )).'bd !important; 
            }
             .applyBtn{
                background-color:'.(empty(get_option( 'cor_ehtl' )) ? '#000000' : get_option( 'cor_ehtl' )).' !important;
                border-color:'.(empty(get_option( 'cor_ehtl' )) ? '#000000' : get_option( 'cor_ehtl' )).' !important
            }
             .applyBtn:hover{
                background-color:'.(empty(get_option( 'cor_ehtl' )) ? '#000000' : get_option( 'cor_ehtl' )).'bd !important
            } 
             ...
             .btnAddRoom:hover{
                color: '.(empty(get_option( 'cor_ehtl' )) ? '#000000' : get_option( 'cor_ehtl' )).'ee; 
            }
             .btnApplyRoom{
                background-color: '.(empty(get_option( 'cor_ehtl' )) ? '#000000' : get_option( 'cor_ehtl' )).'; 
            }
             .btnApplyRoom:hover{
                background-color: '.(empty(get_option( 'cor_ehtl' )) ? '#000000' : get_option( 'cor_ehtl' )).'d4;
            }
             .ripple{
    ...
    $html .= '
                ...
                <div class="col-xs-12" style="width:100%">
                    ...
                    <ul class="nav nav-tabs process-model more-icon-preocess" role="tablist" style="margin: 0;border-bottom: 0;">';
                        if ( shortcode_exists( 'TTBOOKING_MOTOR_RESERVA_FLIGHTS' ) ) {
                            $html .= '<li role="presentation" class="active">
                                <a href="#discover" aria-controls="discover" role="tab" data-toggle="tab" onclick="show_tab(0)" class="active show">
                        ...
                        if ( shortcode_exists( 'TTBOOKING_MOTOR_RESERVA' ) ) {
                            $html .= '<li role="presentation">
                                <a href="#strategy" aria-controls="strategy" role="tab" data-toggle="tab" onclick="show_tab(1)">
                    ...
                    <div class="tab-content">';
                        ...
                        if ( shortcode_exists( 'TTBOOKING_MOTOR_RESERVA_FLIGHTS' ) ) { 
                            ...
                            $html .= '<div role="tabpanel" class="tab-pane active" id="discover">  
                                '.$htmlAereo.'
                            </div>';
                        }
                        ...
                        if ( shortcode_exists( 'TTBOOKING_MOTOR_RESERVA' ) ) {
                            ...
                            $html .= '<div role="tabpanel" class="tab-pane" id="strategy"> 
                                 '.$htmlAereo.'
                            </div>';
                        }
        ...
        $html .= '<script src="//maxcdn.bootstrapcdn.com/bootstrap/4.1.1/js/bootstrap.min.js"></script>
    <script type="text/javascript" src="https://cdn.jsdelivr.net/momentjs/latest/moment.min.js"></script>
    <script type="text/javascript" src="https://cdn.jsdelivr.net/npm/daterangepicker/daterangepicker.min.js"></script>
    <script src="https://owlcarousel2.github.io/OwlCarousel2/assets/owlcarousel/owl.carousel.js"></script>
    <script src="https://www.jqueryscript.net/demo/Customizable-Animated-Dropdown-Plugin-with-jQuery-CSS3-Nice-Select/js/jquery.nice-select.js"></script>
...
function get_html_hotel(){
    $html = '';
    $html .= '<section class="banner">  

        <div class="search-sec container" id="searchHotels">
...
$check_page_exist = get_page_by_title('Finalizar pedido - Vôos', 'OBJECT', 'page');  
...
$check_page_exist = get_page_by_title('Confirmação Pedido - Vôos', 'OBJECT', 'page');  

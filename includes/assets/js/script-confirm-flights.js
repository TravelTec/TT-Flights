...
function list_data_confirmation_flights(){  
	...
	jQuery("#price_total").html(localStorage.getItem("TOTAL_PRICE"));


	jQuery("#titular_order_flight").html(order_accepted.data.attributes.customerName);
	jQuery("#cpf_order_flight").html(order_accepted.data.attributes.customerIdentity); 
	jQuery("#email_order_flight").html(order_accepted.data.attributes.email);
	jQuery("#telefone_order_flight").html(order_accepted.data.attributes.cutomerPhone);
	...
	/* SEND MAIL */ 
		...
		var titular = order_accepted.data.attributes.customerName;
		var cpf_titular = order_accepted.data.attributes.customerIdentity;
		var email_titular = order_accepted.data.attributes.email;
		var telefone_titular = order_accepted.data.attributes.cutomerPhone;
